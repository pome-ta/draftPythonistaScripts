...
@[card][Sandbox and Bookmarks | holzschu/a-shell: A terminal for iOS, with multiple windows](https://github.com/holzschu/a-shell?tab=readme-ov-file#sandbox-and-bookmarks)
...
以降のコードは、記事『[【非推奨】Rubicon-ObjC の手動インストール・インポート](https://zenn.dev/pometa/articles/466cd4b39f9684)』の環境設定を前提として進めます。
