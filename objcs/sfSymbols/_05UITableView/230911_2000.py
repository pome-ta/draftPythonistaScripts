...
# [Pythonista-scripts/Gists/UITableViewController user swipe.py at master · cvpe/Pythonista-scripts](https://github.com/cvpe/Pythonista-scripts/blob/master/Gists/UITableViewController%20user%20swipe.py#L30)

# [Swipe TableViewCell to show multiple actions | omz:forum](https://forum.omz-software.com/topic/7437/swipe-tableviewcell-to-show-multiple-actions)
...
def tableView_sectionForSectionIndexTitle_atIndex_(self, cmd, tableView, title,
                                                   index):
...
def tableView_commitEditingStyle_forRowAtIndexPath_(self, cmd, tableView,
...
methods = [
  ...
  numberOfSectionsInTableView_, tableView_titleForHeaderInSection_,
  tableView_sectionForSectionIndexTitle_atIndex_,
  sectionIndexTitlesForTableView_, tableView_titleForFooterInSection_,
  tableView_commitEditingStyle_forRowAtIndexPath_
]  #, tableView_viewForHeaderInSection_, tableView_heightForHeaderInSection_]
...
UITableViewDelegate = create_objc_class('UITableViewDelegate',
                                        NSObject,
                                        methods=methods,
                                        protocols=protocols)
...
def Main():
  ...
  tableviewcontroller = UITableView.alloc().initWithStyle_(
  ...
  UIContextualAction.setBackgroundColor_(
    ObjCClass('UIColor').blueColor().colorWithAlphaComponent(0.5))

  UISwipeActionsConfiguration = ObjCClass(
    'UISwipeActionsConfiguration').configurationWithActions_(
      [UIContextualAction])
  #=============== TableView delegate: end

  root_vc.presentViewController_animated_completion_(tableviewcontroller, True,
                                                     None)
