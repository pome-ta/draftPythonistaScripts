...
from objc_util import c, ObjCClass, ObjCInstance, create_objc_class, on_main_thread,ns
import ui
...
class TableViewController(object):
  ...
  def init_table_dataSource(self):
    ...
    def tableView_cellForRowAtIndexPath_(_self, _cmd, _tableView, _indexPath):
      ...
      cellIdentifier = ObjCInstance(NSStringFromClass(UITableViewCell))

      #dequeueReusableCellWithIdentifier_
      cell = tableView.dequeueReusableCellWithIdentifier_(cellIdentifier)
      
      
      #cell = tableView.dequeueReusableCell_withIdentifier_for_(cellIdentifier, indexPath)
      if not cell:
...
class ObjcControlView(object):
  ...
  def init_UITableView(self):
    ...
    self.table_view.registerClass_forCellReuseIdentifier_(
      UITableViewCell, ObjCInstance(NSStringFromClass(UITableViewCell)))
