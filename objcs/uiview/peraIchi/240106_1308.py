...
class ObjcTableView(ObjcView):
  ...
  def __init__(self, *args, **kwargs):
    ...
    CGRectZero = CGRect((0.0, 0.0), (0.0, 0.0))
    self.instance.initWithFrame_(CGRectZero,style=0)
...
class TopViewController(_ViewController):
  ...
  def override(self):
    ...
    def setupTableView(_self, _cmd):
      ...
      self.tableView.registerClass_forCellReuseIdentifier_(UITableViewCell, self.cell_identifier)
      ...
      NSLayoutConstraint.activateConstraints_([
        ...
        self.tableView.widthAnchor().constraintEqualToConstant_(128.0),
        ])
  ...
  def create_table_extensions(self):
    ...
    def tableView_cellForRowAtIndexPath_(_self, _cmd, _tableView, _indexPath):
      ...
      cell_image = UIImage.imageWithContentsOfFile_(str(self.dummy_img_path))
