...
class TopViewController(_ViewController):
  ...
  def override(self):
    ...
    def setupUIDStack(_self, _cmd):
      ...
      #self.uid_textfield.layer().setBorderWidth_(8)
      #self.uid_textfield.layer().setBorderColor_(UIColor.systemDarkRedColor())
      #pdbg.state(self.uid_textfield.layer())
      ...
      NSLayoutConstraint.activateConstraints_([
        ...
        self.uid_label.widthAnchor().constraintEqualToAnchor_multiplier_(self.uid_stack.widthAnchor(), 0.1),
        self.uid_text_wrap.widthAnchor().constraintEqualToAnchor_multiplier_(self.uid_stack.widthAnchor(), 0.88),
        
        self.uid_textfield.centerXAnchor().constraintEqualToAnchor_(self.uid_text_wrap.centerXAnchor()),
        self.uid_textfield.centerYAnchor().constraintEqualToAnchor_(self.uid_text_wrap.centerYAnchor()),
        self.uid_textfield.widthAnchor().constraintEqualToAnchor_constant_(self.uid_text_wrap.widthAnchor(), -32),
      ])
