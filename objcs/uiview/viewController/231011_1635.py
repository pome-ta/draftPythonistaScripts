...
class ObjcUIViewController:
  ...
  def setup_viewDidLoad(self, this: UIViewController):
    ...
    # xxx: navigationItem 関係は、`UINavigationController` を`create_objc_class` して、navigation 側で処理してもいいかも
    # --- navigationItem
  ...
  def _override_viewController(self):
    ...
    def viewDidLoad(_self, _cmd):
      ...
      v = UIView.alloc()
      CGRectZero = CGRect((0.0, 0.0), (300, 200))
      v.initWithFrame_(CGRectZero)
      v.setBackgroundColor_(UIColor.systemBlueColor())
      #v.translatesAutoresizingMaskIntoConstraints = True
      v.setAutoresizingMask_((1 << 1) | (1 << 4))
