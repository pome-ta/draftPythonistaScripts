...
public struct BPETokenizer {
    ...
    public func tokenize(input: String, minCount: Int? = nil) -> (tokens: [String], tokenIDs: [Int]) {
        ...
        //print(unknownToken)
        //print(unknownTokenID)

        let ids = tokens.map({ vocabulary[$0, default: unknownTokenID] })
        //print({vocabulary[$0, default: unknownTokenID]})
        //print("tokens")
        //print(tokens)
        //print("ids")
        //print(ids)
    ...
    func encode(word: Substring) -> [String] {
        ...
        //print("if last")
        //print("forEach")
        //let _pairs = pairs(for: tokens)
        //let arrayPairs = _pairs.map{$0}
        //let aPair:TokenPair = arrayPairs[0]
        //print(aPair)
        ////_pairs.forEach{print($0)}
        ////print(merges[arrayPairs[0]])
        ////print(merges[arrayPairs[0]])
        //let m = merges[aPair]
        //print(m ?? "null でっせ")
        ...
        while true {
            ...
            let shouldMerge = canMerge.min {
                print("$0")
                //print(merges[$0] ?? "null かもね")
                dump(merges[$0])

                print("$1")
                //print(merges[$1] ?? "null かもね")
                dump(merges[$1])
                return merges[$0]! < merges[$1]!
                }!
            print("should")
            //print(shouldMerge)
            dump(shouldMerge)
