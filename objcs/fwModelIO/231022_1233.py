...
#color = UIColor.colorWithRed_green_blue_alpha_(rc, gc, bc, ac)
#color = UIColor.colorWithRed(rc, green=gc, blue=bc, alpha=ac)
color = UIColor.color(red=rc, green=gc, blue=bc, alpha=ac)
