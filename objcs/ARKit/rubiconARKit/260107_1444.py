...
ARSCNDebugOptionShowFeaturePoints = objc_const(Foundation, 'ARSCNDebugOptionShowFeaturePoints')

a = str(ARSCNDebugOptionShowWorldOrigin)
aa = ''
#ARSCNDebugOptionShowWorldOrigin = Foundation.in_dll(ARKit, 'ARSCNDebugOptionShowWorldOrigin')
