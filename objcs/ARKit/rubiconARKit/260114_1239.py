...
class MainViewController(UIViewController):
  ...
  def viewWillAppear_(self, animated: bool):
    ...
    sceneDepth = ARFrameSemantics.sceneDepth
    if ARWorldTrackingConfiguration.supportsFrameSemantics_(sceneDepth):
      configuration.setFrameSemantics_(sceneDepth)
